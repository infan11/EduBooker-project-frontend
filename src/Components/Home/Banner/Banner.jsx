...
<div data-aos="zoom-out" className="max-w-md  p-10 rounded-2xl ">
  <h1 className="mb-5 text-3xl text-white font-bold font-mono ">YOUR FAVORITE COLLEGE</h1>
    <div className="flex">
   <Link> <input type="text" placeholder="Search Your Information " className="w-full border-white border-2 p-3 px-14 text-white font-bold rounded-full bg-transparent mb-8  hover:border-white" /></Link>
